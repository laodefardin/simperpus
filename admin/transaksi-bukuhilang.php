            ...
            <div class="col-lg-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title">Data Transaksi Buku Hilang</h3>
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $query = $koneksi->query("SELECT * FROM tb_transaksi WHERE status='Hilang'");
                        $nomor_urut = 1;
                        foreach ($query as $data) :
							...
							?>
                                    ...
                                    <td>
                                        <a href="transaksiproses-gantirugi?id=<?php echo $data['id'];?> &judul=<?php echo $data['judul'];?>"
