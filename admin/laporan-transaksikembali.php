<?php
$halaman = 'Laporan Data Pengembalian Buku';
...
<div class="content">
  ...
  ?>
                ...
                <div class="card card-lightblue">
                    <div class="card-header">
                        <h3 class="card-title">Cetak Report Data Pengembalian Buku</h3>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="tampung1">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                     $query=$koneksi->query( "SELECT * FROM tb_transaksi WHERE status='Kembali'");  $nomor_urut = 1;
...
echo "<script>window.open('cetak/laporantransaksikembali.php', '_blank');</script>";
}
?>
